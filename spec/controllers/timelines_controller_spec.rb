  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved timeline as @timeline" do
        ...
        post :create, {:timeline => { "title" => "invalid value" }}, valid_session
        assigns(:timeline).should be_a_new(Timeline)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested timeline" do
        ...
        Timeline.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => timeline.to_param, :timeline => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the timeline as @timeline" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Timeline.any_instance.stub(:save).and_return(false)
        put :update, {:id => timeline.to_param, :timeline => { "title" => "invalid value" }}, valid_session
        assigns(:timeline).should eq(timeline)
      end
